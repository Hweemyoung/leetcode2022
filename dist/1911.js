...
function findBalanceNonSlice(ar, oddOrEven, startIdx, endIdx) {
    ...
    if (oddOrEven === OddEven.EVEN) {
        while (ptr < startIdx + targetLength) {
            let iMin = ptr, iMax = ptr, min = ar[ptr], max = ar[ptr];
            while (ptr++ < startIdx + targetLength) {
...
var OddEven;
(function (OddEven) {
    OddEven[OddEven["ODD"] = 0] = "ODD";
    OddEven[OddEven["EVEN"] = 1] = "EVEN";
})(OddEven || (OddEven = {}));
function splitArWithIdxPair(ar, idxPair, oddOrEven, startIdx, endIdx) {
    ...
    const subBal = oddOrEven === OddEven.ODD
